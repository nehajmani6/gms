...
Comment by Partha: For this module, any inactive user will get a alert-prompt on the grade management page telling "Session as inactive , do you want to reset the time to start the timer or you want to autolog out". 